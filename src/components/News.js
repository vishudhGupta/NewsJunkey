...
export class News extends Component {
  ...
  constructor(props) {
    ...
    document.title = `${this.CapitlizeString(this.props.category)}-NewsJunkey`;
  }
async updateNews(){
  ...
  render() {
    return (
      ...
      <div className="container my-3">
        <h2 className="text-center">NewsJunky-Top {this.CapitlizeString(this.props.category)} Headlines</h2>
